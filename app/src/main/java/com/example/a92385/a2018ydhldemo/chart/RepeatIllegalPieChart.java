...
public class RepeatIllegalPieChart extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_repeat_illegal_pie_chart, container, false);

        mPieChartIllegalCar = (PieChart) view.findViewById(R.id.pie_chart_repeat_illegal_car);

        dataMap = new HashMap();
        dataMap.put("有重复违章","13.8");
        dataMap.put("无重复违章","86.1");
